<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div x-data="{ open: false }" class="relative hidden sm:flex sm:items-center sm:ms-10">
                    <div class="relative z-10">
                        <button @click="open = !open" class="flex items-center space-x-1 text-gray-800 dark:text-gray-400">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        {{--<div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('student.exam')" :active="request()->routeIs('student.exam')">
                {{ __('Exams') }}
            </x-responsive-nav-link>
        </div>--}}
